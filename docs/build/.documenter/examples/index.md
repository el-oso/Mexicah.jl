...
Each example is a self-contained Julia file in `examples/` and a matching documentation page showing the Julia source, build command, and MATLAB call side by side.
