...
> 
> **Mexicah** — _Matrix-Laboratory EXecutable Interop: Compiled, AOT, Host-free._
> 


**Compile Julia functions into standalone MATLAB MEX extensions.**

Mexicah.jl takes existing Julia code and compiles it into native MEX files (`.mexa64`, `.mexw64`, `.mexmaca64`) that MATLAB users call like any other built-in — with no Julia installation required at runtime.
